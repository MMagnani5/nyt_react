		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'col-md-12' },
					React.createElement(Saved, { history: this.state.saved })
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// This is the search component. It will be used to show a list of searches.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		runQuery: function runQuery(article) {
			...
			nytUrl += '?' + $.param({
				'api-key': "af1815fdf5884c5cb5c5ea9fa52a5e7c",
				'q': article
			});
		...
		postHistory: function postHistory(title) {

			return axios.post('/api/saved', { title: title }).then(function (results) {
